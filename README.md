# Olist E-Commerce Growth & Revenue Analysis

## Project Overview
This project presents an end-to-end analysis of a real-world e-commerce dataset (Olist – Brazil), transforming raw multi-table data into actionable business insights and an executive-level dashboard.

The goal was to identify key growth opportunities, uncover business risks, and provide data-driven recommendations to improve revenue and customer retention.
